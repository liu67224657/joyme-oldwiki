...
return array(
    ...
    'skins.'.$wgDefaultSkin.'.styles' => array(
        'styles' => $deviceskin,
        'remoteBasePath' => $GLOBALS['wgStylePath'],
        'localBasePath' => $GLOBALS['wgStyleDirectory'],
    ),

    'skins.joyme1.styles' => array(
        'styles' => array(
            'MySkin/'.$wgDevice.'/joyme1/screen.css' => array( 'media' => 'screen' ),
            'MySkin/'.$wgDevice.'/joyme1/print.css' => array( 'media' => 'print' ),
        ),
        'remoteBasePath' => $GLOBALS['wgStylePath'],
        'localBasePath' => $GLOBALS['wgStyleDirectory'],
    ),
