...
function showLevelDiv( $input ,$argv ) {
	...
	$str = <<<EOT
$hasinputstr<span style="display:inline;white-space: nowrap;"><form action="#">{$levelname}：<input id="userLevel" type="text" readonly="" value="$maxlevel" style="width: 22px;padding:4px;border:1px solid #CCCCCC;color:#808080;">{$alvstr}</form></span>
...
<script src="http://$host/extensions/jsscripts/LevelTools.js?v=2"></script>
EOT;
	return $str;
}
