...
class DetailTemplate extends BaseTemplate {
    ...
    public function execute() {
		global $com, $wgThread, $wgIsLogin,$wgServer,$wgStaticUrl,$wgWikiStatic;
		if(!$wgThread){
		...
		<script src="<?php echo $wgWikiStatic;?>/extensions/Discussion/jsscript/taolunqu_comment.js"></script>
