<?php
class WikiPostsTemplate extends BaseTemplate {

    function __construct($wikiPostsInfo,$del,$topFilepath,$friendLinkFilepath){
        ...
        $this->filepath = $topFilepath;
        $this->linkFile = $friendLinkFilepath;

        $model = new Specialdiscussion_area();
        $this->del = $model->jurisDiction();
    ...
    function execute() {
        ?>
    <?php global $wgThread,$wgServer,$wgWikiStatic,$wgStaticUrl; if(!$wgThread):?>
    ...
    <?php else:?>
        ...
        <?php if($this->del == 'operation'):?>
            <div class="discuss-title">
            <a href="<?php echo $wgServer;?>/?title=特殊:Wiki讨论区&reco=recovery"><input type="button" value="回收站"></a>
        ...
        <?php if($this->del == 'handle'):?>
            <div class="discuss-title">
            <a href="<?php echo $wgServer;?>/?title=特殊:Wiki讨论区&del=operation"><input type="button" value="管理帖子"></a>
            </div>
        <?php endif;?>
                ...
                <div class="dis-left">
                    ...
                    <div class="joyme-rmsy-tab-box">
                        ...
                        <div class="joyme-rmsy-tab-tit" id="tab">
                            <p class="cur" id="tab_1"><a href="<?php echo $wgServer;?>/?title=特殊:Wiki讨论区">全部帖子</a></p>
                            <em>/</em>
                            <p id="tab_2"><a href="<?php echo $wgServer;?>/?title=特殊:Wiki讨论区&type=1">精品帖子</a></p>
                            <a href="<?php echo $wgServer;?>/index.php?title=THREAD&action=edit&ns=THREAD">发新帖</a>
                                ...
                                <?php foreach($this->PostsInfo as $k=>$v):?>
                                    <?php if(is_numeric($k)):?>
                                        <div class="tab-cont-list">
                                            ...
                                            <a href="<?php echo $wgServer;?>/?title=特殊:Wiki讨论区&details=<?=$v['wiki_title']?>&namespace=<?=$v['page_namespace']?>" target="_blank"><?=$v['wiki_title']?></a>
                                            <?php if($v['is_top'] == 1):?>
                                                <i class="i-blue">置顶</i>
                                            <?php endif;?>
...
<!--                    </div>-->
                    ...
                    <div class="dis-right-box">
                        <div class="hot-tit">友情讨论区
                            <?php if($this->del == 'operation' || $this->del == 'handle'):?>
...
<!--                    <input type="text" id="kkkk2" value="">-->
                    <h4>最多可添加6个讨论区</h4>
                    <div id="_tips">
