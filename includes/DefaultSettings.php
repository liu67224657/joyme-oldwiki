 ...
 */
$wgThumbnailEpoch = '20160105000000';
...
// Implicit group for all logged-in accounts
$wgGroupPermissions['lguser']['move'] = true;
$wgGroupPermissions['lguser']['move-subpages'] = true;
$wgGroupPermissions['lguser']['move-rootuserpages'] = true; // can move root userpages
$wgGroupPermissions['lguser']['movefile'] = true;
$wgGroupPermissions['lguser']['read'] = true;
$wgGroupPermissions['lguser']['edit'] = true;
$wgGroupPermissions['lguser']['createpage'] = true;
$wgGroupPermissions['lguser']['createtalk'] = true;
$wgGroupPermissions['lguser']['writeapi'] = true;
$wgGroupPermissions['lguser']['upload'] = true;
$wgGroupPermissions['lguser']['reupload'] = true;
$wgGroupPermissions['lguser']['reupload-shared'] = true;
$wgGroupPermissions['lguser']['minoredit'] = true;
$wgGroupPermissions['lguser']['purge'] = true; // can use ?action=purge without clicking "ok"
$wgGroupPermissions['lguser']['sendemail'] = true;
...
$wgGroupPermissions['sysop']['wikiposts'] = true;
$wgGroupPermissions['sysop']['label_management'] = true;
// Permission to change users' group assignments
$wgGroupPermissions['bureaucrat'] = $wgGroupPermissions['sysop'];
$wgGroupPermissions['bureaucrat']['userrights'] = true;
$wgGroupPermissions['bureaucrat']['noratelimit'] = true;
$wgGroupPermissions['bureaucrat']['seo_management'] = true;
