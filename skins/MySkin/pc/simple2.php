 ...
 * @ingroup Skins
 */
class SkinSimple2 extends SkinTemplate {

	protected static $bodyClasses = array( 'simple2-animateLayout' );

	var $skinname = 'simple2', $stylename = 'simple2',
		$template = 'Simple2Template', $useHeadElement = true;
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$styles = array( 'mediawiki.skinning.interface', 'skins.simple2.styles' );
 ...
 * @ingroup Skins
 */
class Simple2Template extends BaseTemplate {
	...
	public function execute() {
		global $wgVectorUseIconWatch, $wgSiteGameTitle;
...
//document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Fa5dfc61afa64ba23a2aa56846c00d242' type='text/javascript'%3E%3C/script%3E"));
		...
		<!-- content -->
			...
			?>
			<div class="wiki-tj-tit border-b">
				<h3 id="firstHeading"><?php  $this->html( 'title' ) ?></h3>
				<div class="fn-clear">
                         <span id="share" class="fn-right share-con fn-clear"></span>
                        <?php if(!empty($this->data['lastmodtime'])){ ?><span class="fn-left">最后更新：<?php echo $this->data['lastmodtime'];?></span><?php }?>
                    </div>
			</div>
			<?php } ?>
			<!-- /firstHeading -->
			...
			<!-- bodyContent -->
			<div id="bodyContent">
                                <?php global $wgUser,$wgPhpServer,$wgServer,$wgWikiname, $wgUGCWikis;if (in_array($wgWikiname, $wgUGCWikis)){$rooturl =$wgServer;}else{$rooturl=$wgPhpServer."/wiki/";}if($wgUser->isLoggedIn()){?>
					<?php $this->renderNavigation( array( 'VIEWS', 'ACTIONS' ) ); ?>
					<div id="p-views" class="vectorTabs">
						<ul>
							<li id='ca-edit'><a accesskey="e" href="<?php echo $rooturl; ?>特殊:上传文件">上传文件</a></li>
						</ul>
					</div><br /><br />
				<?php } ?>
		...
		<!-- /panel -->
		<!-- footer -->
		<script src='/extensions/jsscripts/lableLib.js'></script>
		<!-- /footer -->
		<?php $this->printTrail(); ?>
...
<?php
	...
	protected function renderNavigation( $elements ) {
		global $wgVectorUseSimple2Search;
...
<div id="p-search" role="search">
	...
	<form action="<?php $this->text( 'wgScript' ) ?>" id="searchform">
		<?php if ( $wgVectorUseSimple2Search ) { ?>
			<div id="simple2Search">
		<?php } else { ?>
			<div>
		<?php } ?>
			<?php
