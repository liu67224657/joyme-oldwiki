 ...
 * @ingroup Skins
 */
class SkinWca extends SkinTemplate {

	protected static $bodyClasses = array( 'wca-animateLayout' );

	var $skinname = 'wca', $stylename = 'wca',
		$template = 'WcaTemplate', $useHeadElement = true;
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$styles = array( 'mediawiki.skinning.interface', 'skins.wca.styles' );
 ...
 * @ingroup Skins
 */
class WcaTemplate extends BaseTemplate {
...
?>
		...
		<link href="<?php  global $wgServer; global $wgPhpServer;  echo $wgPhpServer;?>/skins/vector/joymecomment.css" rel="stylesheet"/>
		<div id="wrapper">
			<div class="wp-bg clearfix">
				...
				<div class="menubox clearfix">
					<div class="slideMenu">
					    <ul class="clearfix">
					        <li>
					        	<a href="http://wca.joyme.com/wiki/首页" class="top"><em>首页</em><b>HOME</b></a>
					        </li>
					        <li>
					            <a href="http://wca.joyme.com/wiki/热门资讯" class="top"><em>新闻资讯</em><b>NEWS</b></a>
					        </li>
					        <li>
					            <a href="http://wca.joyme.com/wiki/比赛项目" class="top"><em>比赛项目</em><b>EVENT</b></a>
					           
					        </li>
					        <li>
					            <a href="http://wca.joyme.com/wiki/比赛赛程" class="top"><em>赛程安排</em><b>ARRANGE</b></a>
					            
					        </li>
					        <li>
					            <a href="http://wca.joyme.com/wiki/WCA赛事简介" class="top"><em>赛事简介</em><b>INTRODUCTION</b></a>
					            <div>
					                
					            </div>
					        </li>
					    </ul>
					    <span class="pai-bg"></span>
					</div>
				</div>
				<div id="mw-panel">
					<div class="asideNav-t-bg"><a href="http://wca.joyme.com/wiki/首页" class="top">首页</a></div>
					<div class="mw-panel-list">
						<div class="mw-pl">
							<?php $this->renderPortals( $this->data['sidebar'] ); ?>
						</div>
						<div class="asideNav-b-bg"></div>
					</div>
				</div>
		...
		(function(){
			var mod={
				...
				movetag:function(){
					$('#mw-content-text p').first().css({
						'margin-left':'-30px'
					});
				},
				tab:function(){
					$('.idx-list-tag span').each(function(idx) {
			            $(this).on('click',function(){
							var index=$(this).index();
							$(this).addClass('on').siblings().removeClass();
							var parent=$(this).parent('.idx-list-tag');
							parent.siblings('.idx-list-txt').find('span').eq(index).addClass('show').siblings().removeClass();
						});
			        });
				}
			}
...
<div class="portal" role="navigation" id='<?php echo Sanitizer::escapeId( "p-$name" ) ?>'<?php echo Linker::tooltip( 'p-' . $name ) ?> aria-labelledby='<?php echo Sanitizer::escapeId( "p-$name-label" ) ?>'>
	...
	<div class="body">
<?php
		if ( is_array($content) && !empty( $content['list'] )  ) { ?>
		<ul>
<?php
			foreach ( $content['list'] as $key => $val ) { 
			//var_dump($val);exit;
		echo "<li><a href='".$val["info"]["href"]."'>" . $val["info"]["text"] . '</a></li>';
