...
class SkinSimple extends SkinTemplate {
	...
	protected static $bodyClasses = array( 'simple-animateLayout' );

	var $skinname = 'simple', $stylename = 'simple',
		$template = 'SimpleTemplate', $useHeadElement = true;
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$styles = array( 'mediawiki.skinning.interface', 'skins.simple.styles' );
...
//document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Fa5dfc61afa64ba23a2aa56846c00d242' type='text/javascript'%3E%3C/script%3E"));
		...
		<!-- content -->
			...
			<?php }else if(isset($wgSiteGameTitle)){ ?>
				<h1 id="firstHeading" class="firstHeading" style="display:none;"><span dir="auto"><?php  echo str_replace('WIKI', '', strtoupper($wgSiteGameTitle)); ?></span></h1>
			<?php } ?>
			<!-- /firstHeading -->
			<!-- bodyContent -->
			<div id="bodyContent">
